    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCardViewDocente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HomeUserActivity.this, EncuestaActivity.class);
        ...
        mCardViewResultado.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeUserActivity.this, ResultadosActivity.class);
                startActivity(intent);
            }
        });
